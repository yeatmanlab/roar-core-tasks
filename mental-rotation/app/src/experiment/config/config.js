...
export const initConfig = async (
  ...
  const config = {
    ...
    practiceCorpus: practiceCorpus ?? "mental-rotation-practice-pz",
    stimulusCorpus: stimulusCorpus ?? "mental-rotation-pz",
    sequentialPractice: sequentialPractice ?? true,
    sequentialStimulus: sequentialStimulus ?? true,
    buttonLayout: buttonLayout || "default",
    numberOfTrials: numberOfTrials ?? 4,
    storyCorpus: storyCorpus ?? 'story-lion',
    task: taskName ?? 'mental-rotation',
    stimulusBlocks: stimulusBlocks ?? 2,
