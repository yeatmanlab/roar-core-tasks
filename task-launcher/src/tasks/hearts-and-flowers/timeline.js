...
function getHeartOrFlowerPracticeSection(adminConfig, stimulusType) {
  ...
  subtimeline.push({
    timeline: [fixation, stimulus(true, jsPsychAssessmentStage, adminConfig.stimulusPresentationTime), practiceFeedback],
...
function getHeartOrFlowerTestSection(adminConfig, stimulusType) {
  ...
  const subtimeline = []
  subtimeline.push({
    timeline: [fixation, stimulus(false, jsPsychAssessmentStage, adminConfig.stimulusPresentationTime)],
...
function getMixedPracticeSection(adminConfig) {
  ...
  const heartsAndFlowersPracticeTimeline = {
    timeline: [fixation, stimulus(true, AssessmentStageType.HeartsAndFlowersPractice, adminConfig.stimulusPresentationTime), practiceFeedback],
...
function getMixedTestSection(adminConfig) {
  const heartsAndFlowersTimeline = {
    timeline: [fixation, stimulus(false, AssessmentStageType.HeartsAndFlowersStimulus, adminConfig.stimulusPresentationTime)],
